...
const t = {
  de: {
    ...
    heroEyebrow: "Synthwave • Kassetten • Skill",
    heroWelcome: "Willkommen bei",
    heroTitle: "R-K8: Neon-Arcade mit Kassetten, Batterien & Vinyl",
    heroLead: "Lade rote Batterien mit Kassetten grün, steigere deinen Score und pulverisiere Classius Shift-Platten — plus Studio-Set, SynthTennis und tägliche Sets vom Warm-up bis zur Legende.",
    ...
    metaDescIndex:
      "R-K8 — Synthwave-Arcade für iOS. Lade Batterien mit Kassetten, pulverisiere Classius Shift-Platten, spiele Studio-Set & SynthTennis.",
  ...
  en: {
    langLabel: "Language", skip: "Skip to content", navFeatures: "Features", navHow: "How to play", navEu: "EU compliance", heroEyebrow: "Synthwave • Cassettes • Skill", heroWelcome: "Welcome to", heroTitle: "R-K8: Neon arcade with cassettes, batteries & vinyl", heroLead: "Charge red batteries green with cassettes, raise your Score and clear Classius Shift-Platten — plus Studio Set, SynthTennis and daily sets from Warm-up to Legend.", btnGuide: "How to play", btnFeatures: "View features", coreLoop: "Core loop", loop1: "Start and survive waves", loop2: "Earn credits and buy upgrades", loop3: "Optimize your build and push high score", featuresTitle: "Main features", howTitle: "How to play", euTitle: "EU compliance focus", legal: "Legal", imprint: "Imprint", privacy: "Privacy", access: "Accessibility", backHome: "Back to home", imprintLaw: "Information according to 5 TMG", contact: "Contact", responsible: "Responsible for content",
    ...
    metaTitleIndex: "R-K8 — Synthwave Arcade",
    metaDescIndex:
      "R-K8 — synthwave arcade for iOS. Charge batteries with cassettes, clear Classius Shift plates, play Studio Set & SynthTennis.",
...
const extendedContent = {
  de: {
    ...
    heroTitle: "R-K8: Neon-Arcade mit Kassetten, Batterien & Vinyl",
    heroLead: "Lade rote Batterien mit Kassetten grün, steigere deinen Score und pulverisiere Classius Shift-Platten — plus Studio-Set, SynthTennis und tägliche Sets vom Warm-up bis zur Legende.",
    pillWaves: "Wellen & Classius Shift",
    pillDaily: "Tägliches Set",
    pillStyle: "Style-Rang S–D",
    tagGameplay: "Kern-Gameplay",
    secGameplayTitle: "Score, Kassetten & Vinyl",
    secGameplayLead: "Kein klassischer Laser-Shooter: Du lädst Batterien mit Kassetten, baust Score auf und räumst Classius Shift-Platten nur, wenn dein Score höher ist als ihre Zahl.",
    featCoreT: "Kernschleife",
    featCoreD: "Rote Batterien mit Kassetten aufladen, bis sie grün werden — einsammeln hebt deinen Score. Classius Shift-Platten pulverisierst du nur, wenn dein Score höher ist als ihre Zahl.",
    featWavesT: "Wellen & Formationen",
    featWavesD: "Classius Shift-Platten fallen als Vinyl-Regen oder Invader-Gitter. Alle paar Abschüsse steigt die Intensität. Alle 9 Wellen betritt Classius Shift die Bühne.",
    featCombosT: "Combo & Power-Kisten",
    featCombosD: "Vier Classius Shift-Platten innerhalb von 2 Sekunden freimachen spawnt sofort ein Power-up. Fallende Kisten lädst du ebenfalls mit Kassetten, bis sie aufgehen.",
    featCloseCallsT: "Close Calls & Style-Rang",
    featCloseCallsD: "Knapp an Platten, Boss-Noten oder Ram-Angriffen vorbei? Style-Punkte bringen am Run-Ende einen Rang von D bis S — unabhängig vom Score.",
    featCoinsT: "Münzen & Shop",
    featCoinsD: "Platten und Belohnungen bringen Münzen. Im Menü kaufst du permanente Upgrades, Musiktracks und Skins — oder erfüllst damit Tages-Sets.",
    featDifficultyT: "Drei Schwierigkeitsgrade",
    featDifficultyD: "Entspannt (mehr Leben, langsameres Tempo), Klassisch (Default) oder Fortgeschritten (dichter, schneller, seltener Kisten). Jederzeit in Ops umstellbar.",
    featControlsT: "Tippen oder Wischen",
    featControlsD: "Bewege dein Schiff per Tippen oder Wischen. Kassetten feuern automatisch — du konzentrierst dich auf Position, Batterien und Timing.",
    tagSystems: "Power & Build",
    secSystemsTitle: "Power-Ups, Upgrades & Nebenmodi",
    secSystemsLead: "Im Run sammelst du temporäre Power-Ups aus Kisten. Im Hangar kaufst du dauerhafte Upgrades. Zusätzlich: Studio-Set und SynthTennis.",
    featPowerUpsTitle: "Run-Power-Ups",
    puSlowMoT: "Zeitlupe",
    puSlowMoD: "Blau: Classius Shift-Platten und Batterien/Münzen bewegen sich langsamer — ideal zum Neu-Positionieren.",
    puRapidT: "Schnell-Ladung",
    puRapidD: "Gelb: Deine Kassetten laden Ziele kurz deutlich schneller — stark für Combos und Boss-Phasen.",
    puFreezeT: "Freeze",
    puFreezeD: "Violett: Friert Platten, Schüsse und fallende Items ein — dein Schiff bleibt steuerbar. Belohnungsmünzen fliegen weiter.",
    featUpgradesTitle: "Permanente Upgrades (Münz-Shop)",
    upTriT: "Kassetten-Rage",
    upTriD: "Schießt Kassetten in drei Richtungen — vorwärts, links und rechts.",
    upStartT: "Starthilfe",
    upStartD: "Jede Runde startet mit Zählerstand 10 — früher Score und früheres Overload-Potenzial.",
    upGuardT: "Lasst mich in Ruhe!",
    upGuardD: "Fängt zweimal Treffer von stärkeren Platten ab, deren Wert höher ist als dein Score.",
    upTimeT: "Lass dir Zeit",
    upTimeD: "Temporäre Power-Ups halten 2 Sekunden länger.",
    upScanT: "Doppelpack",
    upScanD: "Sichere Platten grün, gefährliche rot. Overload schon ab Score 45 statt 60.",
    upMagnetT: "Zieht euch warm an!",
    upMagnetD: "Zieht fallende Power-ups magnetisch zu deinem Schiff.",
    featMusicT: "Musikbibliothek",
    featMusicD: "Kauf zusätzliche Synthwave-Tracks und wähle Sound für Menü und Gameplay. Ausgerüstete Tracks erscheinen in der unteren Menüleiste.",
    featStudioT: "Studio-Set",
    featStudioD: "Beat-Match-Nebenmodus: Tippe Spalten, kläre drei gleiche Farben übereinander und halte bis zur Überladung durch — Tempo steigt sanft.",
    featTennisT: "SynthTennis",
    featTennisD: "Lokales 2P-Duell oder Training gegen KI: Spiel den Ball mit dem Schläger zurück. Best of 3 — Auszeit von Classius’ Set.",
    tagProgress: "Langzeit-Fortschritt",
    secProgressTitle: "Sets, Ränge & Belohnungen",
    secProgressLead: "Tägliche Sets, Veteran-Ränge mit Skins, Sektoren der Galaxie-Tour und lokale Bestenlisten — alles offline auf dem Gerät.",
    featDailyT: "Tägliches Set",
    featDailyD: "Jeden Tag eine neue Aufgabe — z. B. Classius Shift-Platten pulverisieren, Wellen erreichen, Close Calls landen oder einen Classius-Auftritt beenden. Abschluss bringt Münzen und zählt für deinen Rang.",
    featVeteranT: "Veteran-Ränge & Skins",
    featVeteranD: "Abgeschlossene Tages-Sets steigern deinen Rang: Warm-up → Support → Remixer → Headliner → Legende. Höhere Ränge schalten Skins frei — von RetroSonic bis LEMTA GT.",
    rankRecruit: "Warm-up",
    rankRecruitD: "Start",
    rankPilot: "Support",
    rankAce: "Remixer",
    ...
    featStyleD: "Close Calls sammeln Style-Punkte. Am Game-Over siehst du deinen Buchstaben-Rang von D bis S — unabhängig vom Score.",
    featRewardsT: "Leistungen & Tour",
    featRewardsD: "Im Belohnungsmenü: Beat-Jäger, Rekordjäger, Fortgeschritten-Veteran, Kaufrausch, Sektor-Pionier, Tour-Headliner und mehr. Freigeschaltete Einträge leuchten auf.",
    featLeaderboardT: "Lokale Bestenliste",
    featLeaderboardD: "Top-Runs bleiben auf dem Gerät — optional mit Namen. Kein Account, keine Cloud nötig.",
    featBossT: "Classius Shift",
    featBossD: "Der Endboss betritt die Bühne: Patrouille, Noten-Schüsse, Ram-Angriffe und ab Enrage ein Energy-Volley — den Ball zurückspielen. Sektoren der Tour schalten sich frei.",
    tagGuide: "Schnellstart",
    howTitle: "Spielanleitung",
    s1t: "1. Steuerung & Schwierigkeit",
    s1d: "Unter Ops: Tippen oder Wischen, Entspannt / Klassisch / Fortgeschritten. Sound, Sprache und Datenschutz nach Bedarf.",
    s2t: "2. Tägliches Set checken",
    s2d: "Am Startbildschirm siehst du das heutige Set. Plane den Run — Boss-Auftritte oder Close Calls können das Ziel direkt erfüllen.",
    s3t: "3. Set starten",
    s3d: "Lade Batterien mit Kassetten grün und sammle sie. Pulverisiere Platten nur mit höherem Score. Nutze Kisten, Combos und Overload (Blitz → grüner Kreis).",
    s4t: "4. Upgrades, Modi & Highscore",
    s4d: "Investiere Münzen in Upgrades, Musik und Skins. Probiere Studio-Set und SynthTennis. Jage Style-Rang S und deinen lokalen Rekord.",
  ...
  en: {
    ...
    heroTitle: "R-K8: Neon arcade with cassettes, batteries & vinyl",
    heroLead: "Charge red batteries green with cassettes, raise your Score and clear Classius Shift-Platten — plus Studio Set, SynthTennis and daily sets from Warm-up to Legend.",
    pillWaves: "Waves & Classius Shift",
    pillDaily: "Daily set",
    pillStyle: "Style rank S–D",
    tagGameplay: "Core gameplay",
    secGameplayTitle: "Score, cassettes & vinyl",
    secGameplayLead: "Not a classic laser shooter: charge batteries with cassettes, build Score, and clear Classius Shift-Platten only when your Score beats their number.",
    featCoreT: "Core loop",
    featCoreD: "Charge red batteries with cassettes until they turn green — collect them to raise Score. Clear Classius Shift-Platten only when your Score is higher than theirs.",
    featWavesT: "Waves & formations",
    featWavesD: "Classius Shift-Platten fall as vinyl rain or invader grids. Intensity rises every few clears. Every 9 waves, Classius Shift takes the stage.",
    featCombosT: "Combos & power crates",
    featCombosD: "Clear four Classius Shift-Platten within 2 seconds to spawn a power-up. Falling crates also charge with cassettes until they open.",
    featCloseCallsT: "Close calls & style rank",
    featCloseCallsD: "Barely dodge plates, boss notes or ram attacks? Style points award a D–S letter rank at the end of the run — independent of Score.",
    featCoinsT: "Coins & shop",
    featCoinsD: "Plates and rewards drop coins. Spend them on permanent upgrades, music tracks and skins — or complete daily sets.",
    featDifficultyT: "Three difficulty levels",
    featDifficultyD: "Relaxed (extra lives, slower pace), Classic (default) or Advanced (denser, faster, fewer crates). Change anytime in Ops.",
    featControlsT: "Tap or swipe",
    featControlsD: "Move with tap or swipe. Cassettes fire automatically — focus on position, batteries and timing.",
    tagSystems: "Power & build",
    secSystemsTitle: "Power-ups, upgrades & side modes",
    secSystemsLead: "In a run you grab temporary power-ups from crates. In the hangar you buy permanent upgrades. Also: Studio Set and SynthTennis.",
    featPowerUpsTitle: "Run power-ups",
    puSlowMoT: "Slow-mo",
    puSlowMoD: "Blue: Classius Shift-Platten and batteries/coins move slower — ideal for repositioning.",
    puRapidT: "Rapid Charge",
    puRapidD: "Yellow: your cassettes charge targets much faster for a short time — strong for combos and boss phases.",
    puFreezeT: "Freeze",
    puFreezeD: "Violet: freezes plates, shots and falling items — you stay movable. Reward coins keep flying.",
    featUpgradesTitle: "Permanent upgrades (coin shop)",
    upTriT: "Cassette Rage",
    upTriD: "Fires cassettes in three directions — forward, left and right.",
    upStartT: "Jump-Start",
    upStartD: "Every run starts with counter 10 — earlier Score and earlier Overload potential.",
    upGuardT: "Leave Me Alone!",
    upGuardD: "Absorbs two hits from stronger plates whose value exceeds your Score.",
    upTimeT: "Take Your Time",
    upTimeD: "Temporary power-ups last 2 seconds longer.",
    upScanT: "Double Pack",
    upScanD: "Safe plates glow green, dangerous ones red. Overload from Score 45 instead of 60.",
    upMagnetT: "Bundle Up!",
    upMagnetD: "Pulls falling power-ups magnetically toward your ship.",
    featMusicT: "Music library",
    featMusicD: "Buy extra synthwave tracks and pick sound for menu and gameplay. Equipped tracks appear in the bottom bar.",
    featStudioT: "Studio Set",
    featStudioD: "Beat-match side mode: tap columns, clear three matching colors stacked, survive until overload — the pace rises gently.",
    featTennisT: "SynthTennis",
    featTennisD: "Local 2P duel or practice vs AI: return the ball with your racket. Best of 3 — a break from Classius’ set.",
    tagProgress: "Long-term progress",
    secProgressTitle: "Sets, ranks & rewards",
    secProgressLead: "Daily sets, veteran ranks with skins, galaxy tour sectors and local leaderboards — all offline on device.",
    featDailyT: "Daily set",
    featDailyD: "A new task each day — clear Classius Shift-Platten, reach waves, land close calls or end a Classius set. Completion grants coins and ranks progress.",
    featVeteranT: "Veteran ranks & skins",
    featVeteranD: "Completed daily sets raise your rank: Warm-up → Support → Remixer → Headliner → Legend. Higher ranks unlock skins — from RetroSonic to LEMTA GT.",
    rankRecruit: "Warm-up",
    rankRecruitD: "Start",
    rankPilot: "Support",
    rankAce: "Remixer",
    ...
    featStyleD: "Close calls earn style points. Game over shows a letter rank from D to S — independent of Score.",
    featRewardsT: "Achievements & tour",
    featRewardsD: "In rewards: Beat Hunter, Highscore Hunter, Advanced Veteran, Shopping Spree, Sector Pioneer, Tour Headliner and more. Unlocked entries glow.",
    featLeaderboardT: "Local leaderboard",
    featLeaderboardD: "Top runs stay on device — optional name. No account, no cloud.",
    featBossT: "Classius Shift",
    featBossD: "The end boss takes the stage: patrol, note shots, ram attacks and an enraged energy volley — return the ball. Tour sectors unlock as you win.",
    tagGuide: "Quick start",
    howTitle: "How to play",
    s1t: "1. Controls & difficulty",
    s1d: "In Ops: tap or swipe, Relaxed / Classic / Advanced. Adjust sound, language and privacy as needed.",
    s2t: "2. Check the daily set",
    s2d: "The start screen shows today’s set. Plan your run — boss appearances or close calls can finish the goal.",
    s3t: "3. Start Set",
    s3d: "Charge batteries green with cassettes and collect them. Clear plates only with a higher Score. Use crates, combos and Overload (lightning → green circle).",
    s4t: "4. Upgrades, modes & high score",
    s4d: "Spend coins on upgrades, music and skins. Try Studio Set and SynthTennis. Chase style rank S and your local record.",
