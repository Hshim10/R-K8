...
const extendedContent = {
  de: {
    ...
    cabClassicD: "Mit Kassetten lädst du Batterien auf und sammelst Punkte. Classius-Shift-Platten räumst du nur, wenn dein Score hoch genug ist — mit Combos und Style-Rang.",
    cabMoleK: "Whack",
    ...
    featBossD: "Classius-Shift-Platten tragen Zahlen — weg kommen sie nur, wenn dein Score höher liegt. Knapp vorbei zählt als Close Call und füttert deinen Style-Rang.",
  ...
  en: {
    ...
    cabClassicK: "Flagship",
    cabClassicT: "R-K8 Classic",
    cabClassicD: "Charge batteries with cassettes and build your score. Clear Classius Shift plates only when your score is high enough — with combos and style rank.",
    cabMoleK: "Whack",
    cabMoleT: "Cole the Mole",
    ...
    featBossT: "Classius Shift",
    featBossD: "Classius Shift plates show numbers — you clear them only when your score is higher. A near miss is a close call and feeds your style rank.",
