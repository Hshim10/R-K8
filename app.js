...
const t = {
  de: {
    ...
    heroLead: "Automaten, Shop-Etage, Merch, Sammelkarten und Items — alles im Anime-Cel-Look. Von R-K8 Classic bis Kawashite Ute.",
...
const extendedContent = {
  de: {
    metaDescIndex: "R-K8 — Anime-Arcade-Halle für iOS. Classic, Cole the Mole, AirHockey, SynthRacing-Club, Claw Zone, Nail It und Kawashite Ute — plus Merch, Sammelkarten und Items.",
    metaTitleIndex: "R-K8 — Anime Arcade Hall",
    heroEyebrow: "Anime Arcade Hall",
    heroTitle: "Betritt die Neon-Halle",
    heroLead: "Automaten, Shop-Etage, Merch, Sammelkarten und Items — alles im Anime-Cel-Look. Von R-K8 Classic bis Kawashite Ute.",
    ...
    cabUteK: "Ausweichen",
    cabUteT: "Kawashite Ute",
    cabUteD: "Weiche den Schüssen aus und gib Feuer zurück. Zieh deine Figur zwischen den Bahnen und tipp gleichzeitig Feuer — drei Leben, das Tempo steigt.",
    tagShop: "Obere Etage",
    ...
    shopShelfD: "Permanente Upgrades, Musikbibliothek und Skins — Münzen aus den Spielen investieren.",
    shopProgressT: "Ränge & Bestenliste",
    shopProgressD: "Ränge von Warm-up bis Legende und eine Bestenliste nur auf dem Gerät.",
    ...
    s2t: "2. Modus spielen",
    s2d: "Classic, Cole the Mole, AirHockey, SynthRacing-Club, Claw Zone, Nail It oder Kawashite Ute — jeweils eigener Flow.",
    s3t: "3. Shop & Sammlung",
    ...
    s4d: "Veteran-Ränge, Skins, Musik und lokaler Highscore — alles auf dem Gerät.",
  ...
  en: {
    metaDescIndex: "R-K8 — anime arcade hall for iOS. Classic, Cole the Mole, AirHockey, SynthRacing-Club, Claw Zone, Nail It and Kawashite Ute — plus merch, collectible cards and items.",
    metaTitleIndex: "R-K8 — Anime Arcade Hall",
    heroEyebrow: "Anime Arcade Hall",
    heroTitle: "Enter the neon hall",
    heroLead: "Cabinets, shop floor, merch, collectible cards and items — anime cel style. From R-K8 Classic to Kawashite Ute.",
    navHall: "Hall",
    navShop: "Shop",
    navClassic: "Classic",
    navHow: "How to play",
    ...
    cabUteK: "Dodge",
    cabUteT: "Kawashite Ute",
    cabUteD: "Sidestep the shots and fire back. Drag your fighter between the lanes and tap Fire at the same time — three lives, and the pace climbs.",
    tagShop: "Upper floor",
    ...
    shopShelfD: "Permanent upgrades, music library and skins — invest coins from the games.",
    shopProgressT: "Ranks & leaderboard",
    shopProgressD: "Ranks from Warm-up to Legend, and a leaderboard that stays on your device.",
    tagClassic: "Flagship loop",
    ...
    s2t: "2. Play a mode",
    s2d: "Classic, Cole the Mole, AirHockey, SynthRacing-Club, Claw Zone, Nail It or Kawashite Ute — each with its own flow.",
    s3t: "3. Shop & collection",
    s3d: "Browse merch, spin the lucky wheel, add cards to your album, secure items and bons from Claw Zone.",
    s4t: "4. Push progress",
    s4d: "Veteran ranks, skins, music and a local high score — everything on your device.",
