...
const t = {
  de: {
    ...
    heroLead: "Weiche Classius Shift-Platten-Wellen aus, sammle Credits, schalte Upgrades frei und jage den Highscore im futuristischen Space-Look.",
    ...
    metaDescIndex:
      "R-K8 — Neon-Arcade-Shooter für iOS. Wellen, Power-Ups, Tägliche Sets, Veteran-Ränge und Synthwave-Design.",
  ...
  en: {
    ...
    metaTitleIndex: "R-K8 — Neon Arcade Shooter",
    metaDescIndex:
      "R-K8 — neon arcade shooter for iOS. Waves, power-ups, daily sets, veteran ranks and synthwave style.",
...
const extendedContent = {
  de: {
    ...
    secGameplayLead: "Jede Runde ist ein Aufstieg durch immer hektischere Classius Shift-Platten-Formationen — mit klarem Feedback bei Treffern, Combos und knappen Rettungen.",
    featWavesT: "Wellen & Schwierigkeitsstufen",
    featWavesD: "Classius Shift-Platten erscheinen in Regen- und Invader-Formationen. Alle paar Abschüsse steigt die Schwierigkeitsstufe — schneller, dichter, gefährlicher. Alle 10 Wellen wartet ein Endboss.",
    featCombosT: "Combo-System",
    featCombosD: "Zerstöre mehrere Classius Shift-Platten innerhalb von 1,5 Sekunden für Combo-Feedback mit Screen-Shake, Neon-Flash und Sound. Vier Kills in 2 Sekunden spawnen sofort ein Power-Up.",
    featCloseCallsT: "Close Calls & Style-Rang",
    featCloseCallsD: "Knapp an Classius Shift-Platten, Boss-Kugeln oder Ram-Angriffen vorbei? Das Spiel belohnt riskantes, präzises Fliegen mit Style-Punkten — am Ende der Runde gibt es einen Rang von D bis S.",
    featCoinsT: "Münzen & Belohnungsdrops",
    featCoinsD: "Classius Shift-Platten lassen Münzen fallen, die zum Schiff magnetisch angezogen werden. Nutze sie im Menü für permanente Upgrades, Musiktracks und Skins — oder sammle sie für Tages-Sets.",
    featDifficultyT: "Drei Schwierigkeitsgrade",
    featDifficultyD: "Entspannt (mehr Leben, langsamere Classius Shift-Platten), Klassik (ausgewogenes Original-Balancing) oder Fortgeschritten (schnellere Spawns, aggressivere Bosse). Wählbar jederzeit in den Optionen.",
    ...
    puSlowMoT: "Zeitlupe",
    puSlowMoD: "Blaues Power-Up: Classius Shift-Platten und Münzen bewegen sich langsamer — ideal, um dich neu zu positionieren. Dauer: 8 Sekunden.",
    ...
    puFreezeD: "Violettes Power-Up: Friert Classius Shift-Platten, Schüsse und fallende Items ein — dein Schiff bleibt steuerbar, Belohnungsmünzen fliegen weiter. Dauer: 6 Sekunden. Erscheint ab mittlerer Schwierigkeit.",
    ...
    upGuardD: "Überlebe einmal pro Runde eine Kollision mit einem stärkere Classius Shift-Platte, wenn dessen Wert höher ist als dein Schiff-Zähler.",
    ...
    featDailyD: "Jeden Tag eine neue Aufgabe — z. B. 30 Classius Shift-Platten zerstören, Welle 10 erreichen, einen Boss besiegen oder 3 Close Calls landen. Abschluss bringt Münzen und zählt für deinen Veteran-Rang. Serien werden getrackt.",
    featVeteranT: "Veteran-Ränge & Skins",
    featVeteranD: "Abgeschlossene Tages-Sets steigern deinen Pilot-Rang. Höhere Ränge schalten exklusive Schiffsskins frei — von LEMTA GT bis Gold Phoenix.",
    rankRecruit: "Rekrut",
    rankRecruitD: "Start",
    rankPilot: "Pilot",
    rankAce: "Ass",
    ...
    featRewardsD: "Im Belohnungsmenü findest du Erfolge wie Scharfschütze (50/500/1000 Abschüsse), Highscore-Jäger, Veteran (Fortgeschritten-Modus), Shopping Spree (alle Upgrades & Tracks) und mehr. Freigeschaltete Belohnungen leuchten im Menü auf.",
    ...
    heroLead: "Weiche Classius Shift-Platten-Wellen aus, sammle Münzen, aktiviere Power-Ups, erledige Tägliche Sets und steige vom Rekruten zum Legenden-Piloten auf.",
    btnFeatures: "Alle Features",
    howTitle: "Spielanleitung",
    s1d: "Öffne Optionen: Wähle Tap oder Swipe und stelle Entspannt, Klassik oder Fortgeschritten ein. Passe Sound, Sprache und Datenschutz-Einstellungen nach Bedarf an.",
    s2t: "2. Tägliches Set checken",
    s2d: "Auf dem Startbildschirm siehst du das heutige Set mit Fortschrittsbalken. Plane deinen Run danach — Boss-Kills oder Close Calls können das Tagesziel direkt erfüllen.",
    s3t: "3. Starten & überleben",
    s3d: "Bleibe in Bewegung, sammle Münzen, nutze Power-Up-Kisten und baue Combos. Achte auf den Schiff-Zähler: Ramme schwächere Classius Shift-Platten, weiche stärkeren aus.",
  ...
  en: {
    ...
    secGameplayLead: "Each run is a climb through increasingly hectic Classius Shift-Platten formations — with clear feedback for hits, combos and narrow escapes.",
    featWavesT: "Waves & difficulty tiers",
    featWavesD: "Classius Shift-Platten appear in rain and invader formations. Every few kills the difficulty tier rises — faster, denser, deadlier. An end boss awaits every 10 waves.",
    featCombosT: "Combo system",
    featCombosD: "Destroy multiple Classius Shift-Platten within 1.5 seconds for combo feedback with screen shake, neon flash and sound. Four kills in 2 seconds instantly spawn a power-up.",
    featCloseCallsT: "Close calls & style rank",
    featCloseCallsD: "Barely dodge Classius Shift-Platten, boss orbs or ram attacks? The game rewards risky, precise flying with style points — at the end of the run you get a rank from D to S.",
    featCoinsT: "Coins & reward drops",
    featCoinsD: "Classius Shift-Platten drop coins that magnetically home toward your ship. Spend them in the menu on permanent upgrades, music tracks and skins — or collect them for daily sets.",
    featDifficultyT: "Three difficulty levels",
    featDifficultyD: "Relaxed (extra lives, slower Classius Shift-Platten), Classic (balanced original tuning) or Advanced (faster spawns, aggressive bosses). Change anytime in options.",
    ...
    puSlowMoD: "Blue power-up: Classius Shift-Platten and coins move slower — ideal for repositioning. Duration: 8 seconds.",
    puRapidT: "Rapid fire",
    ...
    puFreezeD: "Violet power-up: freezes Classius Shift-Platten, shots and falling items — your ship stays controllable, reward coins keep moving. Duration: 6 seconds. Appears from mid difficulty onward.",
    ...
    upGuardT: "Enemy Guard",
    upGuardD: "Survive one collision per run with a stronger Classius Shift-Platten when their value is higher than your ship counter.",
    ...
    featDailyD: "A new task every day — e.g. destroy 30 Classius Shift-Platten, reach wave 10, defeat a boss or land 3 close calls. Completion grants coins and counts toward your veteran rank. Streaks are tracked.",
    featVeteranT: "Veteran ranks & skins",
    featVeteranD: "Completed daily sets raise your pilot rank. Higher ranks unlock exclusive ship skins — from LEMTA GT to Gold Phoenix.",
    rankRecruit: "Recruit",
    rankRecruitD: "Start",
    rankPilot: "Pilot",
    rankAce: "Ace",
    ...
    featRewardsD: "The rewards menu includes achievements like Marksman (50/500/1000 kills), High Score Hunter, Veteran (Advanced mode), Shopping Spree (all upgrades & tracks) and more. Unlocked rewards glow in the menu.",
    ...
    heroLead: "Dodge Classius Shift-Platten waves, collect coins, trigger power-ups, complete daily sets and rise from recruit to legend pilot.",
    btnFeatures: "All features",
    howTitle: "How to play",
    s1t: "1. Choose controls & difficulty",
    s1d: "Open options: pick tap or swipe and set Relaxed, Classic or Advanced. Adjust sound, language and privacy settings as needed.",
    s2t: "2. Check the daily set",
    s2d: "The start screen shows today's set with a progress bar. Plan your run around it — boss kills or close calls can complete the daily goal directly.",
    s3t: "3. Start & survive",
    s3d: "Keep moving, collect coins, grab power-up crates and build combos. Watch the ship counter: ram weaker Classius Shift-Platten, dodge stronger ones.",
