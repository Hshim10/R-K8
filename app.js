...
const extendedContent = {
  de: {
    ...
    featVeteranD: "Abgeschlossene Tagesmissionen steigern deinen Pilot-Rang. Höhere Ränge schalten exklusive Schiffsskins frei — von LEMTA GT bis Gold Phoenix.",
    rankRecruit: "Rekrut",
    rankRecruitD: "Start",
    rankPilot: "Pilot",
    rankAce: "Ass",
  ...
  en: {
    ...
    featVeteranD: "Completed daily missions raise your pilot rank. Higher ranks unlock exclusive ship skins — from LEMTA GT to Gold Phoenix.",
    rankRecruit: "Recruit",
    rankRecruitD: "Start",
    rankPilot: "Pilot",
    rankAce: "Ace",
