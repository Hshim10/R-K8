...
const t = {
  de: {
    ...
    heroLead: "Lade rote Batterien mit Kassetten grün, steigere deinen Score und pulverisiere Classius Shift-Platten — plus RythmBlock, SynthTennis und tägliche Sets vom Warm-up bis zur Legende.",
    ...
    metaDescIndex:
      "R-K8 — Synthwave-Arcade für iOS. Lade Batterien mit Kassetten, pulverisiere Classius Shift-Platten, spiele RythmBlock & SynthTennis.",
  ...
  en: {
    ...
    metaTitleIndex: "R-K8 — Synthwave Arcade",
    metaDescIndex:
      "R-K8 — synthwave arcade for iOS. Charge batteries with cassettes, clear Classius Shift plates, play RythmBlock & SynthTennis.",
...
const extendedContent = {
  de: {
    metaDescIndex: "R-K8 — Synthwave-Arcade für iOS. Lade Batterien mit Kassetten, pulverisiere Classius Shift-Platten, spiele RythmBlock & SynthTennis.",
    metaTitleIndex: "R-K8 — Synthwave-Arcade",
    heroEyebrow: "Synthwave • Kassetten • Skill",
    heroTitle: "R-K8: Neon-Arcade mit Kassetten, Batterien & Vinyl",
    heroLead: "Lade rote Batterien mit Kassetten grün, steigere deinen Score und pulverisiere Classius Shift-Platten — plus RythmBlock, SynthTennis und tägliche Sets vom Warm-up bis zur Legende.",
    ...
    featDifficultyD: "Entspannt (langsamer, ruhigeres Spawn-Tempo), Klassisch (Default) oder Fortgeschritten (dichter, schneller, seltener Kisten). Jederzeit in Ops umstellbar.",
    ...
    secSystemsLead: "Im Run sammelst du temporäre Power-Ups aus Kisten. Im Hangar kaufst du dauerhafte Upgrades. Zusätzlich: RythmBlock und SynthTennis.",
    ...
    upStartT: "Starthilfe",
    upStartD: "Jede Runde startet mit Score 10 — früher Score und früheres Overload-Potenzial.",
    ...
    s4d: "Investiere Münzen in Upgrades, Musik und Skins. Probiere RythmBlock und SynthTennis. Jage Style-Rang S und deinen lokalen Rekord.",
  ...
  en: {
    metaDescIndex: "R-K8 — synthwave arcade for iOS. Charge batteries with cassettes, clear Classius Shift plates, play RythmBlock & SynthTennis.",
    metaTitleIndex: "R-K8 — Synthwave Arcade",
    heroEyebrow: "Synthwave • Cassettes • Skill",
    heroTitle: "R-K8: Neon arcade with cassettes, batteries & vinyl",
    heroLead: "Charge red batteries green with cassettes, raise your Score and clear Classius Shift-Platten — plus RythmBlock, SynthTennis and daily sets from Warm-up to Legend.",
    ...
    featDifficultyD: "Relaxed (slower pace, gentler spawns), Classic (default) or Advanced (denser, faster, fewer crates). Change anytime in Ops.",
    ...
    secSystemsLead: "In a run you grab temporary power-ups from crates. In the hangar you buy permanent upgrades. Also: RythmBlock and SynthTennis.",
    featPowerUpsTitle: "Run power-ups",
    puSlowMoT: "Slow-mo",
    ...
    upStartT: "Jump-Start",
    upStartD: "Every run starts with Score 10 — earlier Score and earlier Overload potential.",
    ...
    s4d: "Spend coins on upgrades, music and skins. Try RythmBlock and SynthTennis. Chase style rank S and your local record.",
